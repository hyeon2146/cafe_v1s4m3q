  ...
  <fieldset>
    <ul>
      <li>
        ...
        <input type='text' name='id' id='id' value='${memberVO.id }' required="required">
      ...
      <li>
        ...
        <input type='text' name='address1' id='address1' value='${memberVO.address1 }' size='55' placeholder="주소">  
        <input type='text' name='address2' id='address2' value='${memberVO.address2 }' size='20' placeholder="상세 주소">      
      </li>
      <li>
